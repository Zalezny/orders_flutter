...
import 'package:testapp/web_api/dto/order.dart';
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: itemCart.color!.isEmpty
                              ? Text("rozmiar: ${itemCart.size}", textAlign: TextAlign.center,)
                              : Text("kolor: ${itemCart.color}", textAlign: TextAlign.center,),
                        ),
